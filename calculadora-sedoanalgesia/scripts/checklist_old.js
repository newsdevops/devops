...
(function(){
  ...
  function initChecklist(opts){
    ...
    const checkedStore = loadJson(KEY_CHECK);
    const openMap = loadJson(KEY_OPEN);
    ...
    allDetails.forEach((d, i) => {
      ...
      if(Object.prototype.hasOwnProperty.call(openMap, gid)){
        d.open = !!openMap[gid];
      }
    ...
    function recomputeAll(){
      ...
      if(complete && !wasComplete){
        try{ verifyBtn.scrollIntoView({ behavior: 'smooth', block: 'end' }); }catch(_e){}
      }
