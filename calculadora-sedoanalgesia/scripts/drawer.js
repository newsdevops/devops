...
// ===== MENU + CAMBIO DE VISTA (SEDANTES / ANTÍDOTOS) =====
  ...
  const sectionAlta = document.getElementById('section-alta');
 
  const sectionSuero = document.getElementById('section-sueroterapia');
 
  const sectionHipo = document.getElementById('section-hipoglucemia');
...
if (showHipo && typeof window.renderHipoglucemia === 'function') window.renderHipoglucemia();
