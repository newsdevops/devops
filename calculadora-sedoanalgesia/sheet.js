...
// sheet.js v20251215-3 — filas garantizadas, sticky sin solapes (tbody-offset = header + thead), caps/min Excel, trunc 3 dec sin ceros
(function(){
  'use strict';
...
tablaAnt?.classList.toggle('show-farmaco', filtros.antidotos === null);
  ...
  ENTRADAS.forEach(e => {
    // ✅ filtro por fármaco dentro de su categoría
