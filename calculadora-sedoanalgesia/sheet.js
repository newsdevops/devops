...
// sheet.js v20251221-9 — filas garantizadas, sticky sin solapes (tbody-offset = header + thead), caps/min Excel, trunc 3 dec sin ceros
(function(){
  'use strict';
...
function renderCardsFor(categoria, peso){
  ...
  for(const farmaco of order){
    ...
    grid.appendChild(makeDiv('tgrid__cell tgrid__label tgrid__corner', ''));
    cols.forEach(e => {
